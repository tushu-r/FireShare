...
const SideNav = () => {
  ...
  const [ activeIndex , setActiveIndex ] = useState(location) ;
  ...
  return (
    <div className='shadow-sm border-r h-full'>
        <div className=' my-2 mx-2 p-5 border-b'>
        ...
        <div className=' flex flex-col   text-black my-2'>
          { menuList.map( (item)=>(
              ...
              >
              <div className=" w-fit relative top-[35px] left-[35px]">
                    <Image src={item.icon} width={25} height={25}/>
                  </div>
                <h2 className={`${location==item.path ? 'bg-gray-50 text-primary':null}   text-[25px]  hover:text-[32px]  transition `} >
                  {item.name}
                </h2>
              </button>  
            ))}
